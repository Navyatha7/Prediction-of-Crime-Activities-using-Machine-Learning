...
urlpatterns = [
    ...
    url(r'^thank_you/$', remoteuser.thank_you, name="thank_you"),  
    url(r'^Search_DataSets/$', remoteuser.Search_DataSets, name="Search_DataSets"),
    ...
    url(r'^Find_Crime_Type_Ratio/$', serviceprovider.Find_Crime_Type_Ratio, name="Find_Crime_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Crime_Type/$', serviceprovider.Predict_Crime_Type, name="Predict_Crime_Type"),
